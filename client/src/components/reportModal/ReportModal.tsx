...
export default function ReportModal({ targetType, targetId, token, onClose }: ReportModalProps) {
  ...
  const handleSubmit = async (): Promise<void> => {
    ...
    try {
      ...
      setError(axiosErr.response?.data?.message || "Failed to submit report");
    }
  };
          ...
          <>
            ...
            <div className="reportModalBody">
              ...
              <select value={reason} onChange={(e) => setReason(e.target.value)}>
                ...
                {REPORT_REASONS.map((r: { value: string; label: string }) => (
